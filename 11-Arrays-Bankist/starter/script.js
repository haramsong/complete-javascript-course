...
console.log(`Sarah's dog is eating ${sarahDog.curFood > sarahDog.recommendedFood ? 'too much' : 'properly'}!`)
...
// 7
const okAmountDogs = dogs.filter(dog => dog.curFood > dog.recommendedFood * 0.90 && dog.curFood <= dog.recommendedFood *
1.10)
